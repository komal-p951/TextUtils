  ...
  return (
    <div>
        <div className="form-group mt-5 container" style={{color: props.mode === 'dark' ? 'white' : 'black'}} >
            <h3>{props.heading}</h3>
            <textarea className="form-control" id="exampleFormControlTextarea1" style={{backgroundColor: props.mode === 'dark' ? 'grey' : 'light', color: props.mode === 'dark' ? 'white' : 'black'}} rows="8" placeholder={text}  value={text} onChange={handleOnchange}></textarea>
